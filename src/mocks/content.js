const data = {
    ...
    graphd : {
        ...
        color: '#1E9FD7',
        text: '<p>Отбросьте фразы «нужен вкусный дизайн», «поиграем со шрифтами» и доверьтесь, наконец, профессионалу.</p><p> Я подберу по-настоящему красивые образы и визуальные схемы для вашего продукта, баннера или наружной рекламы. А результатом будут заинтересованные клиенты, которых привлечет интересный визуальный стиль вашего продукта.</p><p>Перед вами лишь некоторые из моих работ:</p>',
        images: [
            {
